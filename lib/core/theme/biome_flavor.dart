...
const Map<String, String> _weatherPhrases = {
  ...
  'forest:night':
      'Тьма между стволами гуще любой тени, и лес словно наблюдает за вами...',

  'desert:sunny': 'Воздух дрожит от жары, а горизонт плывёт маревом.',
  'desert:rain': 'Редкий дождь превращает песок в вязкую корку.',
  'desert:fog':
      'Пыльная дымка стирает горизонт — не разобрать, где небо, где земля.',
  'desert:night': 'Ночной холод пустыни пробирает быстрее любого зверя.',

  'graveyard:sunny':
      'Даже солнце здесь ложится неохотно, между покосившимися камнями.',
  'graveyard:rain':
      'Дождь стекает по надгробиям, будто камни сами оплакивают себя.',
  'graveyard:fog':
      'Туман стелется между могилами — тишина здесь тяжелее любого крика.',
  'graveyard:night':
      'Ночью тишина здесь тяжелее любого крика — и, кажется, не только тишина.',
  ...
  'coast:rain':
      'Дождь сливается с солёными брызгами — не разобрать, где кончается море.',
  'coast:fog': 'Туман глотает горизонт, и шум прибоя доносится будто ниоткуда.',
  'coast:night':
      'Море хранит свои тайны глубже, чем кажется — особенно в темноте.',
};

const Map<String, String> _seasonPhrases = {
  'forest:spring':
      'Молодая листва ещё липкая на ощупь, а лес полон птичьего гомона.',
  'forest:summer':
      'Кроны смыкаются плотным пологом, и в чаще держится густая зелёная тень.',
  'forest:autumn': 'Палая листва глушит шаги, а воздух пахнет прелью и дымом.',
  'forest:winter':
      'Голые стволы скрипят на морозе, а снег между ними лежит нетронутым.',

  'desert:spring':
      'После редких дождей пустыня на пару недель зеленеет колючей травой.',
  'desert:summer':
      'Земля растрескалась от зноя, а марево над барханами не спадает даже к вечеру.',
  'desert:autumn':
      'Жара понемногу отступает, но песок ещё держит дневное тепло всю ночь.',
  'desert:winter':
      'По ночам пустыня выстывает почти до инея — редкий путник готов к этому.',

  'graveyard:spring':
      'Между покосившимися крестами пробивается первая упрямая зелень.',
  'graveyard:summer':
      'Раскалённый камень надгробий пышет жаром весь день напролёт.',
  'graveyard:autumn':
      'Сухие стебли шуршат между могил при каждом порыве ветра.',
  'graveyard:winter':
      'Снег ровным одеялом стирает границы между тропой и могилами.',

  'mountains:spring':
      'Талые ручьи с грохотом несутся по камням, разбухшие от снега на вершинах.',
  'mountains:summer':
      'Снег держится только на самых вершинах — тропы внизу наконец свободны.',
  'mountains:autumn':
      'Камень под ногами покрывается ледяной коркой уже с раннего утра.',
  'mountains:winter':
      'Перевалы завалены снегом по пояс, а тропы читаются с трудом.',

  'coast:spring':
      'После зимних штормов на берег до сих пор выносит обломки и водоросли.',
  'coast:summer':
      'Раскалённый песок и ленивый прибой делают берег почти курортным.',
  'coast:autumn':
      'Шторма становятся всё чаще, а рыбацкие лодки — всё осторожнее.',
  'coast:winter':
      'Ледяные брызги обжигают лицо, а причал понемногу обрастает наледью.',
};
